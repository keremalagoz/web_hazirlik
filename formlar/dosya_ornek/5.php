...
<body>
   ...
   <form name="yukleme" method="post" action="5.php" enctype="multipart/form-data">
      <table border="0">
         <tr>
            <td>Dosya Seçiniz:</td>
...
/* 
Şimdi tam bir dosya yükleme örneği verelim. 
Burada dosyalar kendi adlarıyla upload dizinine kaydedilecektir. 
Tabiki Türkçe'ye özgü karakterler temizlendikten sonra. 
Bunun için bir fonksiyon tanımlayıp kullacağız. 
Ayrıca yükleme aynı sayfada yapılacaktır.
 */
